...
def train(args, env, pic_episode_list):
    ...
    print_freq = args.max_exp_len * 10
    ...
    # training loop
    while time_step <= args.max_ep_num:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--learning_rate_actor', default=0.0003)
    parser.add_argument('--learning_rate_critic', default=0.001)
    ...
    parser.add_argument('--has_continuous_action_space', default=False)
